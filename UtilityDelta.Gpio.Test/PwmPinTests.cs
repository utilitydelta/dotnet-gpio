...
namespace UtilityDelta.Gpio.Test
{
    public class PwmPinTests
    {
        ...
        public void TestPinProps()
        {
            ...
            fileIo.Verify(x => x.WriteAllText("/sys/class/pwm/pwmchip0/pwm43/polarity", "99"), Times.Once);
        ...
        {
            var fileIo = new Mock<IFileIo>();
            fileIo.Setup(x => x.ReadAllText("/sys/class/pwm/pwmchip0/pwm43/polarity")).Returns("33");
